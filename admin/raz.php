...
if ($_SESSION['objet'] != "" && $objet->get_droit(1))
{
	...
	if(isset($_POST['binomes'])) {
		$objet->RAZ($_POST['binomes'], $_POST['eleves'], $_POST['dates'], $_POST['indisponibilites'], $_POST['soutenance'], $_POST['projets']);
	}
	...
	echo '<input type="checkbox" name="soutenance" /> Planning des soutenances<br /><br />';
